const pastaRecipes = [
  ...
  const risottoRecipes = [
      ...
      imageUrl:"https://images.unsplash.com/photo-1637361875628-c8617fdda8db?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80",
  ...
  const dessertRecipes =[
      ...
      { 
        ...
        difficulty: "Advanced",
        difficultyImage: "../src/media/icons/advanced.svg",
        clock: "../src/media/icons/clock.svg",
        diet: "Vegetarian",
        dietImage: "../src/media/icons/vegetarian.svg",
        nutriScore: "E",
        prepTime: "25 min"
